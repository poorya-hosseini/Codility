 ...
 * </p>
 * <p>
 * Write a function that, given an array A consisting of N integers fulfilling the above conditions, returns the value
...
public class OddOccurrencesInArray {
	...
	public static int oddOccurrencesInArray(int[] intArray) {
		int oddValue = 0;
		for (int i : intArray) {
			oddValue ^= i;
		}
